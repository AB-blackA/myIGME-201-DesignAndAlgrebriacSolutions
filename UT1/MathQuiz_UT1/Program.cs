...
namespace MathQuiz_UT1
{
    ...
    class Program
    {
        ...
        start:
            ...
            Console.WriteLine("We're about to begin. In the case of a division equation, ensure your quotient is rounded to the nearest 2 decimals to receive a correct answer.");
            ...
            for (nCntr = 0; nCntr < nQuestions; ++nCntr)
            {
                ...
                else
                {
                    ...
                    sQuestions = $"Question #{nCntr + 1}: {Math.Round(val1, 2)} / {Math.Round(val2, 2)} => ";
                }
                ...
                do
                {
                    ...
                    {
                        Console.WriteLine("Please enter a double rounded to two places.");
                        bValid = false;
                    }
                ...
                else
                {
                    ...
                    Console.WriteLine("I'm sorry {0}. The answer is {1}", myName, Math.Round(nAnswer, 2));
                }
