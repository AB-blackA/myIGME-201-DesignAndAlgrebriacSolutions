...
namespace EditPerson
{
    public partial class PersonEditForm : Form
    {
        ...
        public PersonEditForm(Person person, Form parentForm)
        {
            ...
            */
            ...
            if (person.GetType() == typeof(Student))
            {
                ...
                else if(student.eCollegeYear == collegeYear.freshman)
                {
        ...
        /*Method: ClassRadioButton__CheckedChanged
         *Purpose: Update Label in classGroupBox object to reflect year of graduation based on student status (freshmen, sophmore, jr., or sr.)
         *Limitations: none
         */
        private void ClassRadioButton__CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (rb.Checked)
            {
                if(rb.Text == seniorRadioButton.Text)
                {
                    this.classOfLabel.Text = "Class of 2024";
                }
                else if (rb.Text == juniorRadioButton.Text)
                {
                    this.classOfLabel.Text = "Class of 2025";
                }
                else if (rb.Text == sophRadioButton.Text)
                {
                    this.classOfLabel.Text = "Class of 2026";
                }
                else //implies freshman
                {
        ...
        private void TypeComboBox__SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if(cb.SelectedIndex == 0 )
            {
                ...
                //code added as part of PE-18
                //set classGroupBox to be visible and enabled if student
            ...
            else
            {
                ...
                //code added as part of PE-18
                //set classGroupBox to be invisible and disabled if not student
        ...
        private void OkButton__Click(object sender, EventArgs e)
        {
            ...
            if( this.typeComboBox.SelectedIndex == 0)
            {
                ...
                //update student person college year based on radio button that is checked
            ...
            //update person's gender based on radio button checked
